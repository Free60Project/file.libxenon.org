...
debian_usb="uda:/vmlinux console=tty0 console=ttyS0,115200n8 video=xenonfb panic=60 maxcpus=3"
debian_hdd="sda:/vmlinux console=tty0 console=ttyS0,115200n8 video=xenonfb panic=60 maxcpus=3"
EOF
